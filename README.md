[![Gitpod Ready-to-Code](https://img.shields.io/badge/Gitpod-Ready--to--Code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/bigprof-software/northwind-demo) 

# Northwind Demo

![Northwind screenshots](https://cdn.bigprof.com/appgini-open-source-apps/northwind/screencast.gif)

Northwind Demo is a free open source app.
It a very simple demo application for an imaginary company called *Norhwind*.
It includes a simple emlpoyees table, a product catalog, with product categories,
an orders table (for sales orders), and a customers table.

Northwind was created using [AppGini](https://bigprof.com/appgini/).
...
#### [⇩ Download the latest release](https://github.com/bigprof-software/northwind-demo/releases/latest) ([_Changelog_](https://github.com/bigprof-software/northwind-demo/releases)) | [![](https://cdn.bigprof.com/appgini-open-source-apps/buy-me-a-coffee.gif) *Buy Me A Coffee!*](https://www.buymeacoffee.com/genedy)

## Features

* Manage customers, employees, suppliers and products.
* Place sales orders, with ability to apply a discount.
* Automatic calculation of sales by customer, and by employee.
...
**[Launch private demo on Gitpod](https://gitpod.io/#https://github.com/bigprof-software/northwind-demo)**
...
1. [Download the latest release as a zip file](https://github.com/bigprof-software/northwind-demo/releases/latest).

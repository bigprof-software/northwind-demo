...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	if(strpos($x->HTML, '<!-- tv data below -->')) {
		...
		if($row = db_fetch_row($res)) {
			...
			$sumRow .= '<td class="employees-Photo sum"></td>';
			$sumRow .= '<td class="employees-LastName sum"></td>';
			$sumRow .= '<td class="employees-FirstName sum"></td>';
			$sumRow .= '<td class="employees-Title sum"></td>';
			$sumRow .= '<td class="employees-Age sum"></td>';
			$sumRow .= '<td class="employees-HireDate sum"></td>';
			$sumRow .= '<td class="employees-Country sum"></td>';
			$sumRow .= '<td class="employees-ReportsTo sum"></td>';
			$sumRow .= "<td class=\"employees-TotalSales text-right sum\">{$row[0]}</td>";
			$sumRow .= '</tr>';

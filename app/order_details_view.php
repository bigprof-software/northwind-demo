...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	@include_once("{$currDir}/hooks/order_details.php");
	include_once("{$currDir}/order_details_dml.php");
	...
	$x->ColWidth = [70, 350, 150, 75, 75, 75, 150, ];
	$x->ColCaption = ['Order ID', 'Product', 'Category', 'Unit Price', 'Quantity', 'Discount', 'Subtotal', ];
	$x->ColFieldName = ['OrderID', 'ProductID', 'Category', 'UnitPrice', 'Quantity', 'Discount', 'Subtotal', ];
	$x->ColNumber  = [2, 3, 4, 7, 8, 9, 10, ];
	...
	if(strpos($x->HTML, '<!-- tv data below -->')) {
		...
		if($row = db_fetch_row($res)) {
			...
			$sumRow .= "<td class=\"order_details-Quantity text-center sum\">{$row[0]}</td>";
			$sumRow .= '<td class="order_details-Discount sum"></td>';
			$sumRow .= "<td class=\"order_details-Subtotal text-right sum\">{$row[1]}</td>";
			$sumRow .= '</tr>';

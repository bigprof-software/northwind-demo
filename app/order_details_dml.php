...
function order_details_insert(&$error_message = '') {
	...
	$data = [
		'OrderID' => Request::val('OrderID', '0'),
		'ProductID' => Request::val('ProductID', '0'),
...
function order_details_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	$filterer_OrderID = thisOr($_REQUEST['filterer_OrderID'], '');
	$filterer_ProductID = thisOr($_REQUEST['filterer_ProductID'], '');

	...
	$data = [
		'Picture' => Request::fileUpload('Picture', [
			...
			'failure' => function($selected_id, $fileRemoved) {
				...
				return existing_value('categories', 'Picture', $_REQUEST['SelectedID']);
			},
		]),
...
function categories_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	$templateCode = str_replace('<%%UPLOADFILE(Picture)%%>', ($noUploads ? '' : "<div>{$Translation['upload image']}</div>" . '<i class="glyphicon glyphicon-remove text-danger clear-upload hidden"></i> <input type="file" name="Picture" id="Picture" data-filetypes="jpg|jpeg|gif|png" data-maxsize="204800" accept=".jpg,.jpeg,.gif,.png">'), $templateCode);

	...
	$data = [
		...
		'Photo' => Request::fileUpload('Photo', [
			...
			'failure' => function($selected_id, $fileRemoved) {
				...
				return existing_value('employees', 'Photo', $_REQUEST['SelectedID']);
			},
		]),
		...
		'ReportsTo' => Request::val('ReportsTo', ''),
	];
...
function employees_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	$filterer_ReportsTo = thisOr($_REQUEST['filterer_ReportsTo'], '');
	...
	if($selected_id) {
		...
		$combo_Country->SelectedText = ( $_REQUEST['FilterField'][1] == '14' && $_REQUEST['FilterOperator'][1] == '<=>' ? $_REQUEST['FilterValue'][1] : '');
